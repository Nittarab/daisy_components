...
module DaisyComponents
  class ItemComponentTest < DaisyComponents::ComponentTestCase
    def test_renders_content
      item_text = 'Item content'
      render_inline(ItemComponent.new) { item_text }
    ...
    def test_renders_with_href
      item_text = 'Link Item'
      render_inline(ItemComponent.new(href: '/test')) { item_text }
    ...
    def test_renders_with_custom_class
      ...
      render_inline(ItemComponent.new(class: 'custom-class')) { item_text }
    ...
    def test_renders_with_class_and_href
      ...
      render_inline(ItemComponent.new(href: '/test', class: 'custom-class')) { item_text }
    ...
    def test_renders_with_html_content
      render_inline(ItemComponent.new) { '<span>HTML Item</span>'.html_safe }
