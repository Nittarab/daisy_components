...
module DaisyComponents
  module IconsHelper
    ...
    def metamask_icon(size_class)
      tag.svg(aria_label: 'MetaMask logo', class: size_class, xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 507.83 470.86') do
        tag.defs do
        ...
        safe_join([
                    tag.path(d: 'M482.09.5 284.32 147.38l36.58-86.66z', style: 'fill:#e2761b;stroke:#e2761b;stroke-linecap:round;stroke-linejoin:round'),
                    tag.path(d: 'm25.54.5 196.18 148.27-34.79-88.05zM410.93 340.97l-52.67 80.7 112.7 31 32.4-109.91zM4.67 342.76l32.2 109.91 112.7-31-52.67-80.7z', class: 'b'),
  tag.path(d: 'm143.21 204.62-31.41 47.51 111.9 4.97-3.97-120.25zM364.42 204.62l-77.51-69.16-2.59 121.64 111.71-4.97zM149.57 421.67l67.18-32.8-58.04-45.32zM290.88 388.87l67.38 32.8-9.34-78.12z', class: 'b'),
                    tag.path(d: 'm358.26 421.67-67.38-32.8 5.37 43.93-.6 18.48zM149.57 421.67l62.61 29.61-.4-18.48 4.97-43.93z',class: 'c'),
                    tag.path(d: 'm213.17 314.54-56.05-16.5 39.55-18.09zM294.46 314.54l16.5-34.59 39.75 18.09z',class: 'd'),
                    tag.path(d: 'm149.57 421.67 9.54-80.7-62.21 1.79zM348.72 340.97l9.54 80.7 52.67-78.91zM396.03 252.13l-111.71 4.97 10.34 57.44 16.5-34.59 39.75 18.09zM157.12 298.04l39.75-18.09 16.3 34.59 10.53-57.44-111.9-4.97z', class: 'e'),
                    tag.path(d: 'm111.8 252.13 46.91 91.42-1.59-45.51zM350.91 298.04l-1.99 45.51 47.11-91.42zM223.7 257.1l-10.53 57.44 13.12 67.77 2.98-89.24zM284.32 257.1l-5.36 35.77 2.38 89.44 13.32-67.77z', class: 'f'),
                    tag.path(d: 'm294.66 314.54-13.32 67.77 9.54 6.56 58.04-45.32 1.99-45.51zM157.12 298.04l1.59 45.51 58.04 45.32 9.54-6.56-13.12-67.77z', class: 'g'),
                    tag.path(d: 'M295.65 451.28l.6-18.48-4.97-4.38h-74.93l-4.57 4.38.4 18.48-62.61-29.61 21.86 17.88 44.32 30.81h76.13l44.52-30.81 21.86-17.88z', style: 'stroke-linecap:round;stroke-linejoin:round;fill:#c0ad9e;stroke:#c0ad9e'),
                    tag.path(d: 'm290.88 388.87-9.54-6.56h-55.05l-9.54 6.56-4.97 43.93 4.57-4.38h74.93l4.97 4.38z',style: 'stroke-linecap:round;stroke-linejoin:round;fill:#161616;stroke:#161616'),
                    tag.path(d: 'M490.44 156.92l16.89-81.09L482.09.5 290.88 142.41l73.54 62.21 103.95 30.41 23.06-26.83-9.94-7.15 15.9-14.51-12.32-9.54 15.9-12.13zM.5 75.83l16.89 81.09-10.73 7.95L22.56 177l-12.12 9.54 15.9 14.51-9.94 7.15 22.86 26.83 103.95-30.41 73.54-62.21L25.54.5z', class: 'j'),
                    tag.path(d: 'm468.37 235.03-103.95-30.41 31.61 47.51-47.11 91.42 62.01-.79h92.43zM143.21 204.62 39.26 235.03 4.67 342.76H96.9l61.81.79-46.91-91.42zM284.32 257.1l6.56-114.69 30.22-81.69H186.93l29.82 81.69 6.95 114.69 2.39 36.17.2 89.04h55.05l.4-89.04z', class: 'g')
                  ])
      end
    end
